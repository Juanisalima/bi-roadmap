  ...
  return (
    <div style={{
      ...
      <div style={{ borderBottom: "1px solid #2A2D35", padding: "24px 20px 20px" }}>
        <div style={{
          fontSize: "10px", letterSpacing: "0.2em", color: "#C8A96E",
          textTransform: "uppercase", marginBottom: "6px", fontFamily: "'Courier New', monospace",
        }}>
          Consultoría de Inteligencia de Negocio
        </div>
        <h1 style={{
          fontSize: "clamp(20px, 5vw, 32px)", fontWeight: "normal",
          margin: "0 0 6px", letterSpacing: "-0.02em", lineHeight: 1.1,
        }}>
          De los Datos a las Decisiones<span style={{ color: "#C8A96E" }}>.</span>
        </h1>
        <p style={{
          fontSize: "12px", color: "#8A8A8A", margin: "0 0 12px",
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "5px" }}>
          {industryTags.map(tag => (
            <span key={tag} style={{
              fontSize: "9px", padding: "2px 7px", border: "1px solid #2A2D35",
              borderRadius: "2px", color: "#555", letterSpacing: "0.06em",
            }}>{tag}</span>
          ))}
        </div>
      </div>
      ...
      <div style={{
        ...
        {phases.map((p, i) => (
          <button key={i} onClick={() => setActive(i)} style={{
            ...
            <div style={{
              fontSize: "9px", color: active === i ? p.color : "#555",
              fontFamily: "'Courier New', monospace", marginBottom: "3px",
            }}>Fase {p.number}</div>
            <div style={{
              fontSize: "10px", color: active === i ? "#E8E2D9" : "#777",
              fontWeight: active === i ? "bold" : "normal", lineHeight: 1.3,
            }}>{p.title}</div>
            <div style={{
              fontSize: "9px", color: "#444", marginTop: "2px",
              fontFamily: "'Courier New', monospace",
            }}>{p.duration}</div>
          </button>
        ))}
      ...
      <div style={{ padding: "20px" }}>
        ...
        <div style={{ marginBottom: "20px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "10px" }}>
            ...
            <div>
              <div style={{
                fontSize: "9px", color: "#555", letterSpacing: "0.2em",
                textTransform: "uppercase", fontFamily: "'Courier New', monospace", marginBottom: "2px",
              }}>Fase {phase.number} · {phase.duration}</div>
              <h2 style={{
                fontSize: "clamp(15px, 4vw, 22px)", margin: 0,
                fontWeight: "normal", letterSpacing: "-0.02em",
              }}>{phase.title}</h2>
            </div>
          </div>
          <p style={{ fontSize: "14px", color: "#B0AA9F", margin: "0 0 10px", lineHeight: 1.6 }}>
            {phase.summary}
          </p>
          <p style={{
            fontSize: "12px", color: phase.color, margin: 0,
            fontFamily: "'Courier New', monospace",
            borderLeft: `2px solid ${phase.color}`, paddingLeft: "10px", lineHeight: 1.5,
          }}>
            Objetivo: {phase.goal}
          </p>
        </div>
        ...
        <div style={{ marginBottom: "20px" }}>
          ...
          <div style={{
            padding: "12px 14px", background: "#12151A",
            border: `1px solid ${phase.color}55`, borderRadius: "3px",
            fontSize: "13px", color: phase.color, lineHeight: 1.5,
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "7px" }}>
            {phase.activities.map((activity, i) => (
              <div key={i} style={{
                ...
                padding: "11px 13px", background: "#12151A",
                border: "1px solid #1E2128", borderRadius: "3px",
              }}>
                <span style={{
                  fontSize: "9px", color: phase.color,
                  fontFamily: "'Courier New', monospace", minWidth: "16px", marginTop: "3px",
        ...
        <div style={{
          ...
          borderRadius: "3px", padding: "16px", marginBottom: "20px",
        }}>
          <div style={{
            fontSize: "9px", letterSpacing: "0.2em", color: phase.color,
            textTransform: "uppercase", fontFamily: "'Courier New', monospace", marginBottom: "8px",
          }}>Insight Clave</div>
          <p style={{
            fontSize: "13px", color: "#D0C8BC", margin: 0, lineHeight: 1.7, fontStyle: "italic",
          }}>"{phase.insight}"</p>
        </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "5px" }}>
            {phases.map((p, i) => (
              <div key={i} onClick={() => setActive(i)} style={{
                ...
                padding: "9px 11px", cursor: "pointer", borderRadius: "3px",
                background: active === i ? "#16191F" : "transparent",
                border: active === i ? `1px solid ${p.color}33` : "1px solid transparent",
              }}>
                <div style={{
                  width: "6px", height: "6px", borderRadius: "50%",
                  background: active === i ? p.color : "#333", flexShrink: 0,
                }} />
                <div style={{ flex: 1 }}>
                  <div style={{
                    fontSize: "12px", color: active === i ? "#E8E2D9" : "#666",
                    fontWeight: active === i ? "bold" : "normal",
                  }}>{p.title}</div>
                  <div style={{
                    fontSize: "10px", color: "#444", fontFamily: "'Courier New', monospace",
                  }}>{p.duration}</div>
                </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "7px" }}>
            {[
              ...
              <div key={i} style={{
                ...
                color: "#888", alignItems: "flex-start",
              }}>
      ...
      {/* Footer */}
      <div style={{
        borderTop: "1px solid #2A2D35", padding: "14px 20px",
        display: "flex", justifyContent: "space-between", alignItems: "center",
      }}>
        <span style={{ fontSize: "10px", color: "#444", fontFamily: "'Courier New', monospace" }}>
          FASE {phase.number} DE {String(phases.length).padStart(2, "0")}
        </span>
        <div style={{ display: "flex", gap: "5px" }}>
          {phases.map((p, i) => (
            <div key={i} onClick={() => setActive(i)} style={{
              width: active === i ? "18px" : "5px", height: "3px",
